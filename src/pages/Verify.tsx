...
import { Search, CheckCircle, XCircle, Award, Calendar, Trophy } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Verify the authenticity of Silk Miltra certificates
            </p>
          </div>
            ...
            <Card className="border-green-500/50 bg-green-500/10">
              <CardContent className="py-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    This is an authentic Silk Miltra certificate
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="p-4 bg-background rounded-lg text-center">
                      <p className="text-2xl font-bold text-primary">{certificate.final_mcq_score}%</p>
                      <p className="text-sm text-muted-foreground">Final MCQ Score</p>
                    </div>
                    <div className="p-4 bg-background rounded-lg text-center">
                      <p className="text-2xl font-bold text-primary">{certificate.coding_challenge_score}</p>
                  ...
                  <div className="text-center text-xs text-muted-foreground mt-6 pt-4 border-t">
                    Certificate ID: <span className="font-mono">{certificate.certificate_id}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
