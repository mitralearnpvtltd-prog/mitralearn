      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="mt-0">
            ...
            {(content.submodule === "1.1" || content.submodule === "1.2" || content.submodule === "2.1" || content.submodule === "2.2" || content.submodule === "3.1" || content.submodule === "3.2" || content.submodule === "4.1") ? (
